...
import { Copy, Key, User, Shield } from 'lucide-react';
            ...
            <div className="flex items-center space-x-2">
              <div className="flex-1">
                <input
                  ...
                  value={user?.apiKey || ''}
                  readOnly
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 text-sm font-mono"
                />
              </div>
              <button
